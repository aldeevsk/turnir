...
<form name="login-form" class="login-form" method="post" action="<?php echo e(route('user.login')); ?>">
 <?php echo csrf_field(); ?>
    <div class="header">
		<h1>Авторизация</h1>
...
</script><?php /**PATH C:\OpenServer\domains\turnir\resources\views/login.blade.php ENDPATH**/ ?>